...
RUN curl -o xampp-linux-installer.run "https://www.apachefriends.org/xampp-files/7.2.32/xampp-linux-x64-7.2.32-0-installer.run?from_af=true"
...
# Create a /web folder and a symbolic link to it in /opt/lampp/htdocs. It'll be accessible via http://localhost/web/
# This is convenient because it doesn't interfere with xampp, phpmyadmin or other tools in /opt/lampp/htdocs
RUN mkdir /web
RUN ln -s /web /opt/lampp/htdocs/
